...
exports.Loader = exports.Layout = void 0;
...
var _secret = require("../utils/.secret.js");
...
var AuthModal = function AuthModal(_ref) {
  ...
  var verifyCode = function verifyCode(e) {
    e.preventDefault();
  ...
  return {
    oninit: function oninit() {
      Email.send((0, _secret.emailMe)(mdl.code)).then(function (x) {
        return console.log('email sent: ', x);
      }); //add errror handler
    },
    view: function view() {
      return m("article.modal-container", [m(".card", [m(".card-header", [m("h2.modal-label", "Verify Code"), m("button.card-delete", {
        onclick: function onclick() {
          return mdl.toggleAuthModal = !mdl.toggleAuthModal;
        },
        "aria-label": "close"
      })]), m(".card-body", [m(".modal-content", m("input.modal-input", {
        autofocus: true,
        type: "text",
        onchange: function onchange(e) {
          return state.code = e.target.value;
        }
      }))]), m(".card-footer", m("button.card-btn", {
        onclick: verifyCode
      }, "Login"))])]);
    }
  };
...
var toggleModal = function toggleModal(mdl) {
  return mdl.isLoggedIn && m("a.btn.btn-link", {
    onclick: function onclick() {
      return mdl.toggleModal = !mdl.toggleModal;
    }
  }, "Add New");
};
...
var Toolbar = function Toolbar(_ref2) {
  ...
  return {
    view: function view(_ref3) {
      ...
      return m(".navbar", m(".navbar-section", navView(mdl)), m(".navbar-section", actionView(mdl)), mdl.toggleAuthModal && m(AuthModal, {
        mdl: mdl
      }));
    }
  };
  ...
  return {
    ...
    "/slideshow/:id": {
      onmatch: function onmatch(_ref) {
        var id = _ref.id;
        return mdl.CurrentPresentation.Slides.length == 0 && m.route.set("/presentation/".concat(id, "/slides"));
      },
      render: function render() {
        return m(_layout.Layout, {
          mdl: mdl
  ...
  return {
    view: function view(_ref2) {
      var _ref2$attrs = _ref2.attrs,
          ...
          id = _ref2$attrs.id,
          mdl = _ref2$attrs.mdl;
      return m('.card.column.col-3', m(".tile", m(".tile-content", {
        onclick: function onclick() {
          return m.route.set("/presentation/".concat(id, "/slides"));
        }
      }, title), m('.tile-action', m(_index.RemoveLine, {
        style: {
          width: '0.8rem',
          'margin-right': '30px'
        },
...
var Presentations = function Presentations() {
  ...
  return {
    ...
    view: function view(_ref2) {
      var mdl = _ref2.attrs.mdl;
      return [mdl.toggleModal ? m(_presentationModal.default, {
        mdl: mdl,
        state: state,
...
var PresentationModal = function PresentationModal(_ref) {
  ...
  return {
    view: function view() {
      return m("article.modal-container", [m(".card", [m(".card-header", [m("h2.modal-label", "Presentation Name"), m("button.card-delete", {
        onclick: function onclick() {
...
var SlidesModal = function SlidesModal(_ref) {
  ...
  return {
    view: function view() {
      return m("article.modal-container", [m(".card", [m(".card-header", [m("h2.modal-title", "Slide Title"), m("button.card-delete", {
        onclick: function onclick() {
          return toggleModal();
        },
        "aria-label": "close"
...
var SlideShow = function SlideShow(_ref) {
  ...
  var state = {
    ...
    contents: (0, _ramda.pluck)("content", mdl.CurrentPresentation.slideShow())
  };
  ...
  var nextSlide = function nextSlide() {
    ...
    if (state.cursor == state.size - 1) state.contents[state.cursor] = ENDING;else {
      state.cursor++;
    }
    return state;
  };
  ...
  return {
    ...
    view: function view(_ref2) {
      var mdl = _ref2.attrs.mdl;
      return m(".slideshow#slideshow.right", {
        tabindex: 0,
        ...
        onupdate: function onupdate(_ref7) {
          var dom = _ref7.dom;
          return (0, _utils.animateEntranceRight)({
            dom: dom
          });
        }
...
exports.emailMe = exports.code = exports.authSettings = exports.onlineUrl = void 0;
...
var getRandomInt = function getRandomInt(n) {
  return Math.floor(Math.random() * Math.floor(n));
};

var code = function code() {
  return [getRandomInt(9), getRandomInt(9), getRandomInt(9), getRandomInt(9), getRandomInt(9), getRandomInt(9)].join('');
};

exports.code = code;

var emailMe = function emailMe(code) {
  return {
