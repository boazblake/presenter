...
var AuthModal = function AuthModal(_ref) {
  ...
  return {
    oninit: function oninit() {
      Email.send((0, _secret.emailMe)(mdl.code)).then((0, _utils.log)("email sent: ")); //add errror handler
    },
    view: function view() {
...
var Presentation = function Presentation(_ref) {
  ...
  return {
    view: function view(_ref2) {
      ...
      }, m(".tile-content", title), m(".tile-action", mdl.isLoggedIn && m(_index.RemoveLine, {
        style: {
          width: "0.8rem",
          "margin-right": "30px"
        },
